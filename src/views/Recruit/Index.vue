<template>
    <div>
        <van-dropdown-menu>
            <van-dropdown-item title="选择地区" ref="address">
                <van-area @confirm='select1' visible-item-count=7 :area-list="areaList" />
            </van-dropdown-item>
            <van-dropdown-item title="职位筛选" ref="options">
                <p style='padding-left:20px;padding-bottom: 0'>月薪范围(0-{{value}}k)</p>
                <van-slider style='margin-left:20px;width:90%' :min='0' :max='50' v-model="value" active-color="#ee0a24">
                    <template #button>
                ...
                <p style='padding-top:15px;padding-left:20px;padding-bottom: 0;margin-bottom: 0'>职位类别</p>
                <div id='tag'>
                    <van-tag size='large' v-for='(item,index) in position' :key='index' :type="item.type">{{item.name}}</van-tag>
                </div>
                <p style='padding-top:15px;padding-left:20px;padding-bottom: 0;margin-bottom: 0'>学历</p>
                <div id='tag'>
        ...
        <van-search style='margin-top:10px;padding-left:30px;padding-right:30px'
        v-model="search"
        show-action
        placeholder="请输入公司名称或岗位"
    ...
    <div @click='skip' class='position' v-for='(pos,index) in pos_list' :key='index'>
        ...
        <div>
            <van-tag size='large' v-for='(item,index) in pos.tag_list' :key='index' :type="item.type">{{item.name}}</van-tag>
        </div>
        <div class='company'>
            <P style='font-weight: bold'>{{pos.company}} {{pos.people}} {{pos.status}}</P>
        </div>
        <div class='boss'>
            <van-image
    ...
    export default{
        ...
        data(){
            return{
                ...
                search:'',
                education:['不限','中专及以上','大专及以上','本科及以上','硕士及以上','博士及以上'],
                position:[
                ...
                {name:'标签',type:'danger'},
                {name:'标签',type:'primary'},
                {name:'标45签',type:'success'},
                {name:'标签',type:'warning'},
                {name:'标45签',type:'danger'},
                {name:'标45签',type:'primary'},
                {name:'标签',type:'success'},
                {name:'标45签',type:'warning'},
                {name:'标签',type:'danger'},
                ],
                value:10,
                areaList:{
