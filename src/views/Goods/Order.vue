<template>
  <div class="about">
    ...
    <template #footer>
        <van-button size="small" @click='confirm_data(1)'>退款</van-button>
        <van-button size="small" @click='confirm_data(2)'>确认收货</van-button>
    </template>
</van-card>
...
<template #footer>
    <van-button size="small" @click='confirm_data(3)'>确认退款</van-button>
</template>
</van-card>
